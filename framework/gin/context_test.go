...
import (
	...
	testdata "github.com/lackone/gin-ext/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/lackone/gin-ext/framework/gin.handlerNameTest$", c.HandlerName())
}
